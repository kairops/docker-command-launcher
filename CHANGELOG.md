...
* Use hello-world v0.3.0, md2html v1.2.0 and mdline v0.2.0 ([b3e2a3f](https://github.com/kairops/docker-command-launcher/commit/b3e2a3f))

#### Build

* Update Auto Release Log adding v2.8.0 info with JPL ([acd7e4b](https://github.com/kairops/docker-command-launcher/commit/acd7e4b))

#### Docs

* Generate v2.7.0 changelog with JPL ([a2ea0ec](https://github.com/kairops/docker-command-launcher/commit/a2ea0ec))
...
* Use git-changelog-generator v1.2.1 ([2ba929e](https://github.com/kairops/docker-command-launcher/commit/2ba929e))

#### Build

* Update Auto Release Log adding v2.7.0 info with JPL ([0169b8f](https://github.com/kairops/docker-command-launcher/commit/0169b8f))

#### Docs

* Generate v2.6.1 changelog with JPL ([874519e](https://github.com/kairops/docker-command-launcher/commit/874519e))
